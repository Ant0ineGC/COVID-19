...
fig <- ggplotly(p, tooltip = c("colour", "Date", "text")) %>% config(displayModeBar=FALSE) %>% layout(showlegend = FALSE)
fig
...
fig <- ggplotly(p, tooltip = c("Date", "text")) %>% config(displayModeBar=FALSE)
fig
...
fig <- ggplotly(DCj, tooltip = c("Date", "text")) %>% config(displayModeBar=FALSE) %>% layout(showlegend = FALSE)
fig
...
fig <- ggplotly(DCcum, tooltip = c("Date", "text")) %>% config(displayModeBar=FALSE) %>% layout(showlegend = FALSE)
