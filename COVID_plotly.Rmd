...
```{r eruptions, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=5, fig.fullwidth=TRUE}
...
fig <- ggplotly(p, tooltip = c("Pays", "Date", "text")) %>% config(displayModeBar=FALSE) %>% layout(showlegend = FALSE)
fig
