---
title: "Représentation graphique de l'épidémie de COVID-2019 en temps réel"
...
baseDCj <- read.csv ("Deces_jours_mars_avril_2.csv")
...
# Suppression de la colonne des Province
...
p<- ggplot(dfj, aes(Date, dc)) + 
ggtitle("Nombre de décès journaliers en France") +

geom_col(fill = "#4DB4C1") +
scale_y_continuous(name="Nombre de décès journaliers", limits=c(0, 1500)) +
theme_bw() +
theme(legend.position='none') +
geom_text(aes(x = Date, y = (dc + 20), label = dc), color = "black", size = 2.5) 
...
theme_bw() +
theme(legend.position='none') +
geom_text(aes(x = hosp$Date, y = (hosp$hosp + 400), label = hosp$hosp), color = "black", size = 2.5) +
geom_text(aes(x = hospidf$Date, y = (hospidf$hosp + 400), label = hospidf$hosp), color = "black", size = 2.5) 
...
theme_bw() +
theme(legend.position='none') +
geom_text(aes(x = rea$Date, y = (rea$rea + 100), label = rea$rea), color = "black", size = 2.5) +
geom_text(aes(x = reaidf$Date, y = (reaidf$rea + 100), label = reaidf$rea), color = "black", size = 2.5) 

p + theme(plot.title = element_text(, size=14, face="bold.italic"))

# dc/ jours en Italie

p<- ggplot(dij, aes(Date, dc)) + 
...
p<- ggplot(dusj, aes(Date, dc)) + 
ggtitle("Nombre de décès journaliers au USA") +

geom_col(fill = "#4DB4C1") +
scale_y_continuous(name="Nombre de décès journaliers", limits=c(0, 2500)) +
theme_bw() +
theme(legend.position='none') +
geom_text(aes(x = Date, y = (dc + 20), label = dc), color = "black", size = 2.5) 
...
ggtitle("Mortalité journalière en mars et avril selon les années en France") +
geom_line ()  +
theme_bw() +
scale_x_date(date_breaks = "week", date_labels = "%d %B", limits = c(as.Date("2020-03-01"),as.Date("2020-05-05"))) +
